...
\youranswer{Answer - The variance error goes up while the training error goes down.  The trianing set will be performing better on the training data set but not on the potential future data.}
}
